...
<div class="wrapper flex h-screen">
        ...
        <div class="max-w-md w-full mx-auto">
            <div class="bg-white rounded-lg overflow-hidden "> <!--shadow-2xl-->
                <div class="p-8">
                 ...
                 <div class="flex mb-8">
                     <button class="w-1/3 p-3 mt-4 mr-3 bg-white text-indigo-600 border border-indigo-600 text-lg rounded-full  shadow focus:outline-none" @click="changeView('registrazione')">REGISTRATI</button>
                     <button class="w-1/3 p-3 mt-4 bg-indigo-600 text-white text-lg rounded-full shadow shadow focus:outline-none" @click="changeView('login')" >LOGIN</button>
                 </div>
                    <form method="POST" class="" action="#" onsubmit="return false;" id="login" v-if="currentView === 'login'">
                        ...
                        <div class="mb-5">
                            <span class="z-10 h-full leading-snug font-normal absolute text-center text-indigo-600 absolute bg-transparent rounded text-base items-center justify-center w-9 pl-3 py-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                            </svg>
                        </span>
                        <input type="text" name="username" placeholder="USERNAME" class="px-3 py-3 block w-full p-2.5 rounded-full bg-white border border-indigo-600 relative focus:outline-none focus:shadow-outline w-full pl-10">
                        </div>
  ...
  <path d="M10 2a5 5 0 00-5 5v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2H7V7a3 3 0 015.905-.75 1 1 0 001.937-.5A5.002 5.002 0 0010 2z" />
                ...
                <!--Fase di registrazione-->
                   <form method="POST" class="" action="#" onsubmit="return false;" id="registrazione" v-if="currentView === 'registrazione'">
                        ...
                        <input type="text" name="email" placeholder="EMAIL" class="px-3 py-3 block w-full p-2.5 rounded-full bg-white border border-indigo-600 relative focus:outline-none focus:shadow-outline w-full pl-10">
                        </div>
  ...
  <path d="M10 2a5 5 0 00-5 5v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2H7V7a3 3 0 015.905-.75 1 1 0 001.937-.5A5.002 5.002 0 0010 2z" />
                     ...
                     <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600 z-50" checked><span class="ml-3 text-gray-700">Accetto i <span class="font-medium text-indigo-500 underline">Termini di condizioni d'uso</span></span>
                        ...
                        <div class="flex justify-center">
                        <button class="w-1/3 p-2 mt-4 bg-indigo-600 text-white text-lg rounded-full shadow">REGISTRATI</button>
                        </div>
                    </form>
