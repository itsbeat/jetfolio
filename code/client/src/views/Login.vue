                ...
                <div class="max-w-md w-full mx-auto">
                    <div class="bg-white rounded-lg overflow-hidden "> <!--shadow-2xl-->
                        ...
                        <div class="flex mb-8">
                            ...
                            <button class="w-1/3 p-3 mt-4  text-indigo-600 border border-indigo-600 text-lg rounded-full shadow shadow focus:outline-none" @click="changeView('login')" v-bind:class="currentView == 'login'? 'active' : ''" >LOGIN</button>
                        </div>
                            <form method="POST" class="" action="#" onsubmit="return false;" id="login" v-if="currentView === 'login'">
                                ...
                                <div class="flex justify-center">
                                  <button class="active w-1/3 p-2 mt-4  text-white text-lg rounded-full shadow">ACCEDI</button>
                                </div>
                            </form>
                        <!--Fase di registrazione-->
                          <form method="POST" class="" action="#" onsubmit="return false;" id="registrazione" v-if="currentView === 'registrazione'">
                                ...
                                <div class="flex p-2 text-sm bg-white">
                                    <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600 z-50" checked><span class="ml-3 text-gray-700">Accetto i <span class="color_custom font-medium underline">Termini di condizioni d'uso</span></span>
                                </div>
                                <div class="flex justify-center">
                                  <button class="active w-1/3 p-2 mt-4 text-white text-lg rounded-full shadow">REGISTRATI</button>
                                </div>
                            </form>
                          </div>
                      </div>
