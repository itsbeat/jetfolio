                ...
                <div class="flex justify-between p-2 text-sm bg-white">
                  <div class="flex justify-start p-2 ml-2">
                    <input
                      ...
                      checked
                    /><span class="ml-2 text-gray-700">Ricordami</span>
                  </div>
                  <div class="flex justify-end p-2">
                    <a href="#" class="color_custom font-medium"
          ...
          if(this.regPassword == this.regConfirmPassword)
            {
                ...
                if (!error.data.email) {
                  this.regError= "Email già registrata."
                } else {
                  this.regError= "Qualcosa è andato storto! Riprovare."
                }
              }
            }
            else{
