...
>>>>>>> implementazione-login/registrazione-#11
                ...
                <div class="flex justify-center">
                  <a href="#">
                    <svg
                      ...
                      height="28"
                      fill="currentColor"
                      class="color_custom bi bi-google m-3"
                      viewBox="0 0 16 16"
                    >
                      <path
                  ...
                  <a href="#">
                    <svg
                      ...
                      height="28"
                      fill="currentColor"
                      class="color_custom bi bi-linkedin m-3"
                      viewBox="0 0 16 16"
                    >
                      <path
                  ...
                  <a href="#">
                    <svg
                      ...
                      height="28"
                      fill="currentColor"
                      class="color_custom bi bi-twitter m-3"
                      viewBox="0 0 16 16"
                    >
                      <path
                  ...
                  <a href="#">
                    <svg
                      ...
                      height="28"
                      fill="currentColor"
                      class="color_custom bi bi-facebook m-3"
                      viewBox="0 0 16 16"
                    >
                      <path
                  ...
                  /><span class="ml-3 text-gray-700"
                    ...
                    <a href="#"
                      ><span class="color_custom font-medium underline"
                        >Termini di condizioni d'uso</span
                      ></a
                    ></span
                  >
                </div>
